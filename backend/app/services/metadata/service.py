...
from app.repositories.metadata import repository
...
class MetadataService:
    ...
    async def get_evaluation_results_by_json(self, evaluation_params: EvaluationParams):
        ...
        results, total_count = repository.get_evaluation_results_v2(
    ...
    async def create_dq_model(self, create_params: CreateDQModelParams, mapped_entries):
        ...
        result = await self.repository.save_data_quality_model(
    ...
    async def get_applied_methods_by_dq_model(self, dq_model_id: str):
        ...
        return await self.repository.get_applied_methods_by_dq_model(dq_model_id)
    ...
    async def get_dq_models(self, mapping_process_id: str, method_id: str):
        ...
        result = repository.get_dq_models(onto_id, dataset_id, method_id, mapping_process_id)
        print("result", result)
        return result

    async def get_data_quality_rules(self):
        """Get data quality rules."""
        data_quality_rules = repository.get_data_quality_rules()
